<div class="p-6 lg:p-8 bg-white border-b border-gray-200">
    ...
    <h1 class="mt-8 text-2xl font-medium text-gray-900">
        ¡Bienvenido a tu aplicación {{ config('app.name') }}!
    </h1>

    <p class="mt-6 text-gray-500 leading-relaxed text-justify">
        Has accedido a una vista que normalmente no es necesaria en el proceso, pero no te preocupes: todo está
        funcionando correctamente. Este acceso adicional confirma que el sistema está estable y seguro. Para continuar
        con tu gestión, simplemente presiona el enlace que aparece a continuación.
    </p>
    <p class="mt-4 text-sm">
        <a href="{{ route('filament.dashboard.pages.dashboard') }}" class="inline-flex items-center font-semibold text-indigo-700">
